    ...
    <DashboardLayout>
      ...
      <div className="mb-8">
        ...
        <nav className="mb-4 flex items-center gap-2 text-sm">
          ...
          <Link href="/reports/weekly" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 transition-colors duration-200">
            Reports
          </Link>
          <span className="text-gray-400 dark:text-gray-600 transition-colors duration-200">/</span>
          <span className="text-gray-900 dark:text-gray-100 font-medium transition-colors duration-200">Monthly Report</span>
        </nav>
