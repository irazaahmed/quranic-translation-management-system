  ...
  if (meetings.length === 0) {
    return (
      <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-6 transition-colors duration-200">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white transition-colors duration-200">Recent Meetings</h3>
  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-6 transition-colors duration-200">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white transition-colors duration-200">Recent Meetings</h3>
        <Link href="/meetings" className="text-sm font-medium text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors duration-200">
          View all meetings
        </Link>
      </div>
        ...
        {meetings.slice(0, 5).map(({ meeting, language }) => (
          <li key={meeting.id}>
            <Link
              ...
              className="block rounded-lg border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-4 transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700"
            >
