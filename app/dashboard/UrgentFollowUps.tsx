...
export default function UrgentFollowUps({ languages }: UrgentFollowUpsProps) {
  return (
    <div className="rounded-xl border border-red-200 dark:border-red-900/50 bg-red-50 dark:bg-red-900/20 p-6 transition-colors duration-200">
      <div className="mb-4 flex items-center gap-2">
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/40 transition-colors duration-200">
          <svg className="w-4 h-4 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
          </svg>
        </div>
        <div>
          <h3 className="text-lg font-semibold text-red-900 dark:text-red-300 transition-colors duration-200">Immediate Follow-up Required (7+ Days)</h3>
            ...
            return (
              <li key={lang.id}>
                <Link
                  ...
                  className="block rounded-lg border border-red-200 dark:border-red-900/50 bg-white dark:bg-gray-900 p-4 transition-all duration-200 hover:bg-red-50 dark:hover:bg-gray-800"
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        {daysSince !== null && (
                          <span className="inline-flex items-center rounded-full bg-red-100 dark:bg-red-900/40 px-2 py-0.5 text-xs font-medium text-red-800 dark:text-red-300 transition-colors duration-200">
