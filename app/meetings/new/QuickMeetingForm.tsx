...
export default function QuickMeetingForm({ languages }: QuickMeetingFormProps) {
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      {/* Error Message */}
      {state.error && (
        <div className="rounded-lg border border-red-200 dark:border-red-900/50 bg-red-50 dark:bg-red-900/20 p-4 transition-colors duration-200">
